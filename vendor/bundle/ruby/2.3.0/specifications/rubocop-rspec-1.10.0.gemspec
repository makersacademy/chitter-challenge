# -*- encoding: utf-8 -*-
# stub: rubocop-rspec 1.10.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rubocop>.freeze, [">= 0.42.0"])
      s.add_development_dependency(%q<rake>.freeze, [">= 0"])
      s.add_development_dependency(%q<rspec>.freeze, [">= 3.4"])
      s.add_development_dependency(%q<simplecov>.freeze, [">= 0"])
      s.add_development_dependency(%q<anima>.freeze, [">= 0"])
      s.add_development_dependency(%q<concord>.freeze, [">= 0"])
      s.add_development_dependency(%q<adamantium>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<anima>.freeze, [">= 0"])
      s.add_dependency(%q<concord>.freeze, [">= 0"])
      s.add_dependency(%q<adamantium>.freeze, [">= 0"])
