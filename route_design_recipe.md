...
# List all the makers
Request: GET /makers
Response: list of all makers

# Find a single maker
Request: GET /makers/1
Response: of a single maker
after providing e-mail and password
...
# List all the peeps in a reverse chronological order
Request: GET /peeps
Response: list of all peeps
