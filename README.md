Chitter Challenge
=================
Week 4: Weekend challenge - small Twitter clone that will allow the users to post messages to a public stream.
...
postgres=# CREATE DATABASE chitter; # create a new chitter database
