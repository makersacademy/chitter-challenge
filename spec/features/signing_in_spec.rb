feature 'Signing in' do
  ...
  scenario 'Sign in is unsucessful when the user enters an incorrect username' do
    register_user
    visit '/'
    click_button 'Sign in'
  ...
  scenario 'Sign in is unsucessful when the user enters an incorrect password' do
    register_user
    visit '/'
    click_button 'Sign in'
    fill_in 'username', with: 'testuser'
