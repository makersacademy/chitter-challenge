feature 'user can sign up' do
  ...
  scenario 'I can sign up as a new user' do
    expect { sign_up(email:'alice@example.com', name: 'Alice',
              username: 'Wonderland', password: 'orange',
              password_confirmation: 'orange') }.to change(User, :count).by(1)
  ...
  scenario 'cannot sign up if password confirmation does not match' do
    expect { sign_up(email:'alice@example.com', name:'Alice',
              username:'Wonderland', password:'orange',
              password_confirmation: 'apple') }.not_to change(User, :count)
