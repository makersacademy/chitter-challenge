feature 'viewing peeps' do
  ...
  scenario 'user sees all messages in reverse chronological order' do
    Peep.create(text: 'added first', posted_on: posted_time)
    Peep.create(text: 'added second', posted_on: posted_time)
    Peep.create(text: 'added third', posted_on: posted_time)
    visit '/peeps'
  ...
  scenario 'peep shows the time it was posted' do
    Peep.create(text: text, posted_on: posted_time)
    visit '/peeps'
