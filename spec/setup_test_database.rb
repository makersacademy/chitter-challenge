...
def setup_test_database
  ...
  connection.exec("INSERT INTO users (name, username, email, password) VALUES('Burrito', 'burrito', 'burrito@catbowl.com', 'fish123')")
  connection.exec("INSERT INTO peeps VALUES(DEFAULT, 1, 'Hello, Chitter!', current_timestamp)")
  connection.exec("INSERT INTO users (name, username, email, password) VALUES('Larry', 'Larry', 'larry@catbowl.com', 'mouse123')")
