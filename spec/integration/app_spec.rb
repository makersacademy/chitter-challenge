...
describe Application do
  ...
  describe "POST to /new_peep" do
    ...
    describe "POST to /delete_peep/:id" do
      ...
      it "should delete the peep and redirect the main page" do
        response = post "/delete_peep/1", confirmation_answer: "Yes"
  ...
  describe "GET to /:username/edit_profile" do
  ...
  describe "POST to /:username/edit_profile/:attribute" do
  ...
  describe "GET to /:username/password" do
  ...
  describe "POST to /:username/password" do
  ...
  describe "GET to /:username/delete_account" do
  ...
  describe "POST to /:username/delete_account" do
