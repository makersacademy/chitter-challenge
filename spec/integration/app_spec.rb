...
RSpec.describe Application do
  ...
  describe "get /login" do
    it "returns login page" do
      ...
      expect(response.body).to include('<form action="/login" method="post" class="login-signup-form">')
  ...
  describe "get /signup" do
    it "returns signup page" do
      ...
      expect(response.body).to include('<form action="/signup" method="POST" class="login-signup-form">')
  ...
  describe "get '/peep/:peep_id' (view comments)" do
    ...
    context "when logged in" do
      it "returns the page with a post comment function" do
        ...
        expect(response.body).to include('<input type="textarea" name="content" placeholder="Type your comment here..." required>')
