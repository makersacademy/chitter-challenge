...
describe User do
  describe '.create' do
    ...
    it 'creates a hashed password using BCrypt' do
      ...
      User.create('magnus', 'Magnus the Red', 'sorcerer@great-crusade.org',
                  'prosperoburns')
    end
  end
  describe '.all' do
  ...
  describe '.retrieve' do
    it 'returns a user instance from their id' do
      user1 = User.create('magnus', 'Magnus the Red',
                          'sorcerer@great-crusade.org', 'prosperoburns')
  ...
  describe '.authenticate' do
    it 'returns a user instance if the username and password exist' do
      user = User.create('magnus', 'Magnus the Red',
                         'sorcerer@great-crusade.org', 'prosperoburns')
      authenticated = User.authenticate('sorcerer@great-crusade.org',
                                        'prosperoburns')
