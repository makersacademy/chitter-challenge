...
describe User do 
  ...
  describe '.add' do
    it 'adds a new user to the user database' do
      user = User.add(email: 'test@test.com', password: 'testpwd123', username: 'tester123')
    ...
    it 'encrypts the password with bcrypt' do 
      ...
      User.add(email: 'test@example.com', password: 'password123', username: 'tester123')
    end 
  ...
  describe '.authenticate' do 
    it 'returns the user that matches the inputted email and password' do
      user = User.add(email: 'test@example.com', password: 'test123', username: 'Tester')
