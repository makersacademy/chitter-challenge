...
describe UserRepository do
    ...
    it "returns all records" do
      ...
      expected = [
        have_attributes(
          ...
          password_hash: '$2a$12$5/u2wF0CJwS4FvE5fF7lXeJnTlylSmfEQUmxAjgJ5F62n8GqBUxUq',
          name: 'Alice',
        ...
        have_attributes(
          ...
          password_hash: '$2a$12$wWYnwD0ji3Xr7PFAkY7zxOAfoHCMU9MPc./bLvZCjBvES3TlI6tgW',
          name: 'Bob',
        ...
        have_attributes(
          ...
          password_hash: '$2a$12$grGbWj5HFH9lk7PmQtbMYeyZyfnJQ9t7f8dNqGSL3zeKlZiRrVXSW',
          name: 'Carol',
  ...
  describe "#find_by_if" do
    it 'returns matching record by id' do
      ...
      expect(repo.find_by_id(2)).to match(expected)
    end
  end
  ...
  describe "#find_by_username" do
    it 'returns matching record by username' do
      ...
      expect(repo.find_by_username('bobthebuilder')).to match(expected)
    end
  end
