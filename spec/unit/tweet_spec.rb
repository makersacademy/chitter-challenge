...
describe Tweet do
  ...
  describe ".add_tweet" do
    it "fails because the username does not exist" do
      is_inserted = Tweet.add_tweet(username: 'this_username_does_not_exist', message: 'This is my first tweet')
  ...
  describe ".display_tweets" do
    it "shows tweets" do
      ...
      is_inserted = Tweet.add_tweet(username: username, message: tweet_message)
