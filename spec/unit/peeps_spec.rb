...
describe Peeps do
  ...
  describe '.all' do
    it 'should return a list of all peeps' do
      peep = Peeps.create(username: 'EllieM', userid: 1, content: 'Test peep 1', time: '10:00')
      Peeps.create(username: 'EllieA', userid: 2, content: 'Test peep 2', time: '11:00')
      Peeps.create(username: 'EllieB', userid: 3, content: 'Test peep 3', time: '12:00')
      ...
      expect(peeps.first.username).to eq 'EllieM'
  ...
  describe '.create' do
    it "should create a new peep and add it to the database" do
      ...
      expect(peep.username).to eq 'EllieM'
