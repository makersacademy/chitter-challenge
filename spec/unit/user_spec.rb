...
#       User.create('test2@example.com', 'password123', 'test2', 'test2')
...
#       User.create('test3@example.com', 'password123', 'test3', 'test3')
...
#       User.create('test4@example.com', 'password1234', 'test4', 'test4')
