TRUNCATE TABLE users, peeps, comments RESTART IDENTITY; 
 ...
 INSERT INTO users (username, email, password) VALUES ('willj836', 'willj836@gmail.com', '$2a$12$qZftpejLCZEL.VsA6AlqQuGbmu9w0BqxiynJJVVbVhBYy7vXCf6p2');
 INSERT INTO users (username, email, password) VALUES ('OptimusPrime', 'op123@hotmail.com', '$2a$12$scb1HVd9i.wxFpEUnN8WmOHPWkJWl5uM8BbDbKkooRqbvQlKeqt56');
 INSERT INTO users (username, email, password) VALUES ('Jill', 'jill@yahoomail.com', '$2a$12$cby4ZhTpJs46tkAVtHfL2eq3WlW2K505kGvWnftkyGgZ3QNPd3Tqa');
