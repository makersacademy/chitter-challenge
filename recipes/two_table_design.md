...
chitter, contents, date, user, user_name,email,password
```
...
1. Can one user have many chitters? YES
2. Can one chitter have many users NO

-> Therefore,
-> An user HAS MANY chitters
-> An chitter BELONGS TO an user
