...
I want to see all peeps in reverse chronological user
...
peep, time, email, password, name, username
```
...
| Record                | Properties          |
| --------------------- | ------------------  |
|  peeps                | content, time, name, username
|  users                | email, pw, name, username

1. Name of the first table (always plural): `peeps` 

    Column names: `content`, `time`, `name`, `username` 
