...
```
peep, message, time, first name, last name, username, email, password
```
...
| --------------------- | ------------------  |
| peeps                 | content, time
| users                 | first name, last name, username, email, password
...
2. Name of the second table (always plural): `users` 
    ...
    Column names: `first_name`, `last_name`, `username`, `email`, `password`
