...
- Homepage to list all posts, log in link and link to sign up page GET '/'

- Sign Up Page post info to db confirms you're signed up on new page 
  Links back to homepage to view posts - Also logs you in after sign up POST '/sign_up'

- Log In page changes value to true in db, confirms sign in and returns you to home page POST

- Create post field checks user is logged in???
