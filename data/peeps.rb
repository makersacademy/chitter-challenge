PEEPS = [
  ...
  { text: "If a cup cake falls from a tree, how far away will it be from down? #cupcakes",
    time_offset: (22.3 * 9),
    username: "officialjaden" },
  { text: "Ed Balls",
    time_offset: (21.5 * 8),
  ...
  { text: "How can mirrors be real if our eyes aren't real",
    time_offset: (5.3 * 3),
    username: "officialjaden" },
  { text: "@vannio What did you use to make your twitter clone? http://chitter-not-twitter.herokuapp.com #twitter",
    time_offset: (23.4),
    username: "makersacademy" },
  { text: "@makersacademy Sinatra, DataMapper, Postgres, Rspec, Capybara and some other stuff I couldn't fit into 140 chars",
    time_offset: (22.1),
    username: "vannio" },
  { text: "If newborn babies could speak, they would be the most intelligent beings on planet earth",
    time_offset: (18.7),
    username: "officialjaden" },
  { text: "Gahd I love monospace fonts",
    time_offset: (15.2),
    username: "vannio" },
].freeze
