PEEPS = [
  ...
  { text: "How can mirrors be real if our eyes aren't real",
    time_offset: (5.3 * 3),
    username: "officialjaden" },
  { text: "@vannio What did you use to make your twitter clone? http://chitter-catter.herokuapp.com #twitter",
    time_offset: (23.4),
    username: "makersacademy" },
  { text: "If newborn babies could speak, they would be the most intelligent beings on planet earth",
    time_offset: (18.7),
    username: "officialjaden" },
  { text: "@makersacademy Let's see.. I used Sinatra, DataMapper, Postgres, Rspec, Capybara and some other stuff I couldn't fit into 140 chars",
    time_offset: (3),
    username: "vannio" },
].freeze
