...
Peep.create(message: 'The second peep in the test database', user_id: 1)
...
Peep.create(message: 'The fifth peep in the test database', user_id: 1)
Peep.create(message: 'The sixth peep in the test database', user_id: 1)
