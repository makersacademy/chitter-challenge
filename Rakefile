...
task :setup do
  ...
  connection.exec('CREATE TABLE users (id SERIAL PRIMARY KEY, email VARCHAR (240) NOT NULL UNIQUE, password VARCHAR (24) NOT NULL, name VARCHAR (24) NOT NULL, username VARCHAR (24) NOT NULL UNIQUE)')
